...
def save_mfccs(dataset_path, json_path, n_mfcc=13, n_fft= 2048, hop_length= 512, num_segments=30):
...
if __name__ == "__main__":
    save_mfccs(DATASET_PATH, JSON_PATH, num_segments=30)
